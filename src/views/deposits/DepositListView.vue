...
// Any filter dropdown change should also reset to page 1 — calling load()
// directly while on page 2+ would silently return empty results if the
// newly filtered set is smaller than the current page number, even
// though the filter itself is applied correctly server-side.
