...
import {
  HomeIcon, UserGroupIcon, CreditCardIcon, ChartBarIcon, Cog6ToothIcon
...
// Fixed 5-tab bottom nav matching the reference mobile app. Each tab is a
// hub page (views/hub/*) that links into the real existing routes — see
// those files for what's included/omitted and why.
const tabs = [
